...
// PhonesSeparator is the separator used when storing multiple phones in the phone column
const PhonesSeparator = "||"
...
var ValidTypes = []string{
	...
	"Technology", "Artist",
	"Research Institution", "International Organization", "Media",
}
